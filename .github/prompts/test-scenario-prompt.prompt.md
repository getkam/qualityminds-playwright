...
4. Add corresponding playwright tags to given test and testcases

5. Run all tests after implementation to confirm that no existing tests are broken.

6. Synchronize the status in #file:../../specs/TEST_PLAN.md by clearly marking which parts of each scenario are now covered by automated tests.
